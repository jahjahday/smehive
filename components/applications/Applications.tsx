...
export const Applications = () => {
  return (
    <div className="flex justify-between mt-[48px] max-xl:block max-xl:w-[50em] gap-6 max-sm:[15em]">
      <div className="border-[1px] border-solid rounded-[16px] w-full h-full px-4">
        <Nav />
        <div>
          <div className="flex gap-10">
            <div className="h-[40%] w-[40%] mx-auto relative">
              <h1 className="absolute left-[3em] top-[3.2em] text-[1.8rem] font-Archivo font-[700] leading-[2rem]  max-xl:left-[2.2em] max-xl:top-[2.3em]">98</h1>
            <Chart />
            </div>
            <Body />
          </div>
      ...
      <div className="border-[1px] border-solid rounded-[16px] w-full h-full max-xl:mt-4 px-4">
        ...
        <div>
          <div className="flex  gap-10">
            <div className="h-[40%] w-[40%] mx-auto relative">
            <h1 className="absolute left-[2.7em] top-[3.2em] text-[1.8rem] font-Archivo font-[700] leading-[2rem] max-xl:left-[1.7em] max-xl:top-[2.3em]">120</h1>
            <Chart />
            </div>
            <Body />
          </div>
